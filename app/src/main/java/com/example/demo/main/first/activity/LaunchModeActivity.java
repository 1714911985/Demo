...
import com.example.demo.main.first.activity.auxiliary.SingleInstanceActivity;
import com.example.demo.main.first.activity.auxiliary.SingleTaskActivity;
import com.example.demo.main.first.activity.auxiliary.SingleTopActivity;
import com.example.demo.main.first.activity.auxiliary.StandardActivity;
...
public class LaunchModeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        Toolbar toolbar = findViewById(R.id.tb_launch_mode);
